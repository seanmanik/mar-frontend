...
export { default as IconUSDC } from "./resource/usdc.png";
...
export { default as IconPuppyPoint } from "./resource/icon-puppy-point.png";
export { default as IconWalletYellow } from "./resource/icon-wallet-yellow.png";
