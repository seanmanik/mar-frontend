import { Box, DialogContent, DialogTitle, Modal, ModalClose, ModalDialog, ModalProps, Stack, Typography } from "@mui/joy";
...
export default memo<ModalProps & {
    ...
    return <Modal {...modalProps}>
        <ModalDialog variant={"outlined"} size="sm" sx={{
            ...
            <DialogContent>
                <Box maxWidth={'700px'} minWidth={'350px'} borderRadius={10} padding={2} marginTop={2} sx={{
