...
import { Box, Chip, IconButton, Stack, Tab, TabList, TabPanel, Tabs, Typography, tabClasses } from '@mui/joy'
            ...
            header={
                <Box>
                    <Stack direction={"row"} alignItems={"center"}>
                        <Typography level='title-md' sx={{ color: 'white' }}>dbm.eth</Typography>
                        <BorderColor sx={{ color: 'white', fontSize: "15px", marginLeft: 1 }} />
                    </Stack>
                    <Stack direction={"row"} alignItems={"center"}>
                        <Typography sx={{ color: 'white', fontSize: 14, fontWeight: 500 }}>
                            {account.address?.slice(0, 6)}...{account.address?.slice(-4)}
                        </Typography>
                        <ContentCopy sx={{ color: 'white', fontSize: "12px", marginLeft: 1 }} />
                    </Stack>
                </Box>
            }
        >
