        ...
        <Box sx={{
            ...
            <Stack direction={"row"} alignItems={"center"} justifyContent={"space-between"}>
                ...
                <Stack direction={"row"} alignItems={"center"} justifyContent={"flex-end"} spacing={1}>
                    <Button variant="outlined" color="neutral" endDecorator={<EmojiObjects fontSize="small"/>}
                        onClick={() => setOpenModalHowToLevelUp(true)}
                        >How to Level Up</Button>
                    <Button variant="solid" color="primary" endDecorator={<Bolt fontSize="small"/>}>Mint NFT Booster</Button>
                </Stack>
            </Stack>
