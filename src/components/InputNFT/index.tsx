...
}>(({ title, symbol, nftIds, value, openseaLink, blurLink, onChange }) => {
  return (
    <Box>
      <Box
        sx={{ borderRadius: "12px", border: "1px solid #e0e0e0", padding: 1 }}
      >
        <Stack
          direction={"row"}
          spacing={1}
