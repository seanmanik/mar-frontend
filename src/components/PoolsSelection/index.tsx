...
const PoolsSelection = ({ poolSelected, setPoolSelected }: { poolSelected: string, setPoolSelected: (_: string) => void }) => {
    return <Stack direction="row" gap={1} alignItems="center" justifyContent="space-between">
        <Stack direction="column">
            <Typography sx={{
                ...
                fontSize: '24px',
                color: '#ffffff'
            }}>Explore pools</Typography>
            <Typography sx={{
                fontWeight: 500,
                fontSize: '16px',
                color: 'rgba(255, 255, 255, 0.5)'
            }}>Deposit and Earn Points</Typography>
        </Stack>

        <Stack direction="row" gap="4px" alignItems="center" sx={{
            paddingX: '12px',
            paddingY: '8px',
            ...
            <div onClick={() => setPoolSelected('puppy')}><Box sx={{
                paddingX: '20px',
                paddingY: '8px',
            ...
            <div onClick={() => setPoolSelected('mar')}><Box sx={{
                paddingX: '20px',
                paddingY: '8px',
