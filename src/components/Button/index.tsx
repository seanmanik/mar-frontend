...
const Button = ({ justifyContentChild = 'space-between', sx, buttonType, children, endDecorator, ...props }: IButtonProps) => {
    if (buttonType === 'secondary') {
        ...
        >
            <Stack direction='row' width="100%" alignItems="center" justifyContent={justifyContentChild} gap={1}>
