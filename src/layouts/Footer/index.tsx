...
import { IconDiscord, IconGithub, IconLanguage, IconTele, IconTwitter } from '../../icons';

const Footer = () => {
    return (
        <Box bgcolor={'white'} width="100%" paddingY={"42px"}>
            <Stack direction={"row"} maxWidth={1420} paddingLeft={'20px'} paddingRight={'20px'} height={166} alignItems={"center"} margin={"auto"} justifyContent={"space-between"} >
                ...
                <Stack direction="column" minWidth={"20%"} height="100%" justifyContent="space-between">
                    <Stack direction="row" alignItems="center" justifyContent="space-between" width="100%">
                        <Typography fontWeight={500} width="50%">Contact Us</Typography>
                        <Typography fontWeight={500} width="50%">Documentation</Typography>
                    </Stack>
                    <Stack direction="row" alignItems="center" justifyContent="space-between" width="100%">
                        <Typography fontWeight={500} width="50%">Careers</Typography>
                        <Typography fontWeight={500} width="50%">Help Center</Typography>
                    </Stack>
                    <Stack direction="row" alignItems="center" justifyContent="space-between" width="100%">
